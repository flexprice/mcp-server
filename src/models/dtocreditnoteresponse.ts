...
import {
  CreditNoteReason,
  CreditNoteReason$zodSchema,
} from "./creditnotereason.js";
import {
  CreditNoteStatus,
  CreditNoteStatus$zodSchema,
} from "./creditnotestatus.js";
import { CreditNoteType, CreditNoteType$zodSchema } from "./creditnotetype.js";
import {
  DtoInvoiceResponse,
...
export type DtoCreditNoteResponse = {
  ...
  credit_note_status?: CreditNoteStatus | undefined;
  ...
  refund_status?: PaymentStatus | undefined;
...
export const DtoCreditNoteResponse$zodSchema: z.ZodType<DtoCreditNoteResponse> =
  z.object({
    ...
    credit_note_status: CreditNoteStatus$zodSchema.optional(),
    ...
    reason: CreditNoteReason$zodSchema.optional(),
    refund_status: PaymentStatus$zodSchema.optional(),

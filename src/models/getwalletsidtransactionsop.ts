...
export const GetWalletsIdTransactionsOrder$zodSchema = z.enum([
  "asc",
  "desc",
]);
...
export const GetWalletsIdTransactionsStatus$zodSchema = z.enum([
  "published",
  "deleted",
  "archived",
]);
...
export const GetWalletsIdTransactionsRequest$zodSchema: z.ZodType<
...
> = z.object({
  ...
  order: GetWalletsIdTransactionsOrder$zodSchema.optional(),
  priority: z.int().optional(),
  reference_id: z.string().optional(),
  reference_type: z.string().optional(),
  start_time: z.string().optional(),
  status: GetWalletsIdTransactionsStatus$zodSchema.optional(),
...
export type GetWalletsIdTransactionsResponse =
  | DtoListWalletTransactionsResponse
  | ErrorsErrorResponse;

export const GetWalletsIdTransactionsResponse$zodSchema: z.ZodType<

...
import {
  ...
  WalletTransactionFilter$zodSchema,
} from "../models/wallettransactionfilter.js";
...
export function walletsQueryWalletTransaction(
  ...
  request: WalletTransactionFilter,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => WalletTransactionFilter$zodSchema.parse(value$),

...
import {
  ...
  WorkflowExecutionFilter$zodSchema,
} from "../models/workflowexecutionfilter.js";
...
export function workflowsQueryWorkflow(
  ...
  request: WorkflowExecutionFilter,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => WorkflowExecutionFilter$zodSchema.parse(value$),
